        ...
        <div class="card-body">
            ...
            <form action="{{ route('utilisateurs.update', $utilisateur->id_utilisateur) }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nom" id="nom" class="form-control" value="{{ old('nom', $utilisateur->nom) }}" required>
                </div>
                <div class="form-group mb-3">
                    <label for="prenom">Prénom:</label>
                    <input type="text" name="prenom" id="prenom" class="form-control" value="{{ old('prenom', $utilisateur->prenom) }}" required>
                </div>
                <div class="form-group mb-3">
